...
from board.geom import (BANK_N, CHIPS, H, PCB_H, PCB_W, PITCH, X_CORE, X_PCB, X_PCB_END, X_REAR,
                        SOCKET_H, X_SVC, X_VRM, Y_BANK_L, Y_BANK_R, Y_CPU0, Y_CPU1, Y_PSU_BOT, Y_PSU_TOP)
