...
from board.geom import H, PCB_H, PCB_W, PITCH, X_CORE, X_PCB, X_PCB_END, X_REAR, X_SVC, Y_BANK_L, Y_BANK_R
...
def render(cv):
    ...
    cv.busy(X_CORE - 16, Y_BANK_L - 14, 348, Y_BANK_R + 8 * PITCH - Y_BANK_L + 20)
