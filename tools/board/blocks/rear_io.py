...
def render(cv):
    ...
    cv.callouts.append((X_IO - 30, BY + 12, X_IO + 4, BY + 40, "Telegram", "end", "https://t.me/cosmdandy", "eth",
                        "написать", "telegram"))
    cv.callouts.append((X_IO - 30, BY + 82, X_IO + 4, BY + 74, "Twitter", "end", "https://x.com/cosmdandy", "tw",
                        "мысли", "twitter"))
    cv.callouts.append((X_IO - 30, BY + 152, X_IO + 4, BY + 112, "Email", "end", "mailto:i@cosmdandy.dev", "bmc",
                        "i@cosmdandy.dev", "email"))
