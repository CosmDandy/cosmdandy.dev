...
def render(cv):
    ...
    cv.callouts.append((X_IO - 30, 480, X_IO + 4, BY + 46, "Telegram", "end",
                        "https://t.me/cosmdandy", "eth", "написать", "telegram"))
    cv.callouts.append((X_IO - 30, 574, X_IO + 4, BY + 104, "Twitter", "end",
                        "https://x.com/cosmdandy", "tw", "мысли", "twitter"))
    cv.callouts.append((X_IO - 30, 668, X_IO + 4, BY + 153, "Email", "end",
  ...
  <g class="pick-body">
    ...
    {rj45(X_IO+16, BY + 138)}
    {act_led(9, X_IO+8, BY + 136, 3, "#b58900", salt=6, aux=True)}
  </g>
