...
SWITCHES = (
    {'id': 'sw10', 'model': 'SX-3208', 'label': '10G SFP+', 'kind': '10G',
     'ports': 8, 'media': 'SFP+', 'rate': '10 Гбит/с', 'uplink': '2× 25G'},
    {'id': 'sw1', 'model': 'SX-1224', 'label': '1GbE', 'kind': '1G',
...
NET_UPLINK = {'ocp': 'sw10', 'eth': 'sw1', 'tw': 'sw1'}
