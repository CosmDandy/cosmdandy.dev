...
# Жидкостный контур: плита водоблока и шланг.
#
# Плита — единственная тёплая и светлая деталь на этой плате, и такой она стоит
# на живой машине: медь под золотистой анодировкой. Тон взят с фотографии
# R760 с DLC, а не подобран к схеме, — на снимке плита светлее всего, что
# вокруг неё, включая память.
#
# Шланг рядом с ней почти чёрный, но не чёрный: у армированного рукава тон
# тёплый, коричневатый, и на светлой плите это видно.
PLATE = "#bfa87f"          # анодированная плита водоблока
PLATE_DIM = "#8d7a58"      # её же тон в тени и на кромке
BRASS = "#b8974f"          # головки прижимных винтов
TUBE = "#241f19"           # тело шланга
TUBE_LIT = "rgba(223,232,234,0.12)"   # блик по верхней образующей
