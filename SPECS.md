...
циклом обновления по банку, корзина читает диски блоками, и из прочитанного
складывается граф вкладов. Сцен пока три — у процессора, у памяти и у дисков;
у остальных узлов щелчок работает как прежде, уходом сразу.
