...
циклом обновления по банку, а сетевые гнёзда показывают, куда уходит их
трафик. Сцен пять — `cpu`, `dimm`, `ocp`, `eth`, `tw`; у остальных узлов
щелчок работает как прежде, уходом сразу.
